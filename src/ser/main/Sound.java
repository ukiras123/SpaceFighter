...
class Sound {
	...
	private Clip gunClip, menuClip, boomClip, gameClip;
	private AudioInputStream gun, boom, menu, game;
	public static boolean menuPlaying, gamePlaying;
	...
	public Sound() {
		...
		try {
			...
			boom = AudioSystem.getAudioInputStream(url2);
			gun = AudioSystem.getAudioInputStream(url1);
